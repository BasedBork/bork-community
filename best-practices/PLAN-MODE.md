...
## When Claude Enters Plan Mode Automatically

Claude may suggest plan mode when:
- The task involves multiple files
- There are multiple valid approaches
- Requirements are ambiguous

You can always decline and proceed directly.

---

[← CLAUDE.md Guide](./CLAUDE-MD-GUIDE.md) | [Permissions →](./PERMISSIONS.md)
