...
A 15-minute walkthrough to get comfortable with Claude Code.
...
This keeps you in control. See [PERMISSIONS.md](./PERMISSIONS.md) for details.
...
1. **Learn Plan Mode**: The feature that makes Claude Code powerful for complex tasks
   - [Plan Mode Guide](../01-core-concepts/PLAN_MODE.md)

2. **Set Up CLAUDE.md**: Configure Claude for your specific project
   - [CLAUDE.md Guide](../02-claude-md/)

3. **Try a Real Project**: Build something from scratch
   - [First Projects](../03-first-projects/)
...
[← Install](./INSTALL.md) | [Permissions →](./PERMISSIONS.md)
